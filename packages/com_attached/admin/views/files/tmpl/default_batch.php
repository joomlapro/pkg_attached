...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_ATTACHED_BATCH_OPTIONS'); ?></h3>
	</div>
	<div class="modal-body">
		<p><?php echo JText::_('COM_ATTACHED_BATCH_TIP'); ?></p>
	...
	<div class="modal-footer">
		...
		<button type="submit" class="btn btn-primary" onclick="Joomla.submitbutton('file.batch');">
			<?php echo JText::_('JGLOBAL_BATCH_PROCESS'); ?>
		</button>
	</div>
	<div>
		<input type="hidden" name="batch[move_copy]" value="m">
	</div>
</div>
